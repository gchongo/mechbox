...
const GEAR = {
  zh: {
    ...
    modes: stdCalcModes('zh', {
      ...
      simplePass: '**通过判定恒为否**（仅估算）；仍显示应力与分项 ✓/✗',
      completePass: '**综合通过** = $(S_H\\ge S_{H,\\min}) \\land (S_F\\ge S_{F,\\min})$；默认 $S_H\\ge1$，$S_F\\ge1.4$',
      proPass: '**综合通过** = compare.bothPass：ISO 与 AGMA 的 contactPass **且** bendingPass **均须** ✓',
