...
export const RELATED_TOOLS = {
  ...
  'standards-ref': ['key', 'pin-retainer', 'o-ring', 'gdt-symbols', 'standards-catalog'],
  'standards-catalog': ['gdt-symbols', 'gdt-stack', 'fit', 'glossary', 'standards-ref'],
  'gdt-symbols': ['gdt-stack', 'fit', 'editor', 'standards-catalog'],
  'gdt-stack': ['gdt-symbols', 'fit', 'editor', 'standards-catalog'],
