<template>
  <div class="mech-diagram">
    ...
    <svg class="mech-diagram__svg" viewBox="0 0 480 260" role="img" aria-label="螺纹参数示意图">
      ...
      <text :x="boltX + boltLen / 2" :y="cy + boltR + 34" class="txt-primary" font-size="12" text-anchor="middle">d = {{ diameter }} mm</text>
      ...
      <text :x="nutX + nutW + 26" :y="cy + 4" class="txt" font-size="12">L</text>
      ...
      <text :x="boltX + boltLen + 72" :y="cy + 4" fill="#8b5cf6" font-size="12">F</text>

      <!-- P -->
      <line x1="72" y1="210" x2="72 + pitchPx" y2="210" class="dim-primary" marker-start="url(#th-arrow-blue)" marker-end="url(#th-arrow-blue)" />
      <text :x="72 + pitchPx / 2" y="226" class="txt-primary" font-size="11" text-anchor="middle">P</text>
    </svg>
  </div>
</template>
