<template>
  <div>
    ...
    <p class="mb-6 text-gray-600">常用工程材料力学性能参考值（GB/T）</p>
    ...
    <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
      <div v-for="m in filtered" :key="m.id" class="card-panel">
        ...
        <dl class="mt-3 grid grid-cols-2 gap-2 text-sm">
          ...
          <div><dt class="text-gray-500">[σ]</dt><dd class="font-mono">{{ m.sigmaAllow }} MPa</dd></div>
          <div><dt class="text-gray-500">[τ]</dt><dd class="font-mono">{{ m.tauAllow }} MPa</dd></div>
...
import { MATERIALS, searchMaterials, getCategories } from '@/constants/materials'
